...
import 'package:marina_mobility/presentation/screens/login/login_screen.dart';
import 'package:marina_mobility/presentation/screens/splash/splash_screen.dart';

class AppPages{
  static var list = [
    GetPage(name: AppRoutes.splashScreen, page: () => const SplashScreen(), binding: InitialBindings()),
    GetPage(name: AppRoutes.loginScreen, page: () => LoginScreen(), binding: LoginBinding()),
  ];
}